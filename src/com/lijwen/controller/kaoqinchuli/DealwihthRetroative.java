...
import com.lijwen.service.kaoqinchuli.buqiandenji.IdealwihthRetroativeSv;
...
public class DealwihthRetroative {
	...
	@RequestMapping("selectDealwihthRetroative")
     ...
     public void selectDealwihthRetroative(int checkStateId,PrintWriter pw) {
		List<com.lijwen.vo.DealwihthRetroative> list=idealwihthRetroativeSv.selectDealwihthRetroative(checkStateId);
		String str =Json.listToJson(list);
		pw.write(str);
	}
